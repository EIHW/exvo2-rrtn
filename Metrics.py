...
class UncertaintyRevised(nn.Module):
    def __init__(self):
        ...
        self.log_vars = nn.Parameter(torch.FloatTensor([1, 1, 0.001]))

    def forward(self, loss1, loss2, brl):
